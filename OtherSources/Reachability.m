...
- (BOOL)checkInternetConnectionAndDisplayAlert:(NSString *)errorTitle errorMsg:(NSString *)errorMsg
{
	...
	{
		UIAlertView *alert = [[UIAlertView alloc] initWithTitle:errorTitle message:errorMsg delegate:nil cancelButtonTitle:NSLocalizedString(@"OK", nil) otherButtonTitles:nil];
		[alert show];
