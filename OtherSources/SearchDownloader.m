...
{	
	...
	NSString *iTunesCode = [NSString stringWithFormat:@"%ld,2", (long)[[CountryManager sharedManager] iTunesCodeForKey:[[NSUserDefaults standardUserDefaults] objectForKey:@"LocaleName"]]];
