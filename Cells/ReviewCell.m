...
- (id) initWithStyle:(UITableViewCellStyle)style reuseIdentifier:(NSString *)reuseIdentifier
{
	...
	{
		self.reviewTitle = [[UILabel alloc] initWithFrame:CGRectZero];
		...
		reviewTitleBackground = [[UILabel alloc] initWithFrame:CGRectZero];
		reviewTitleBackground.backgroundColor = [UIColor lightGrayColor];
		
		self.reviewAuthor = [[UILabel alloc] initWithFrame:CGRectZero];
		self.reviewAuthor.font = [UIFont boldSystemFontOfSize:12];
		self.reviewAuthor.numberOfLines = 0;
		
		self.reviewText = [[UILabel alloc] initWithFrame:CGRectZero];
		self.reviewText.font = [UIFont systemFontOfSize:12];
		self.reviewText.numberOfLines = 0;
		
		self.reviewVersion = [[UILabel alloc] initWithFrame:CGRectZero];
		...
		self.reviewVersion.textAlignment = NSTextAlignmentRight;
		
		self.ratingImage = [[UIImageView alloc] initWithFrame:CGRectMake(10, 0, 85, 16)];
