...
- (void)downloadComplete
{
	...
	self.navigationItem.rightBarButtonItem = [[UIBarButtonItem alloc] initWithTitle:NSLocalizedString(@"Download", nil) style:UIBarButtonSystemItemSave target:self action:@selector(presentDownloadView)];
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    if(cell == nil)
	{
        cell = [[CountryCell alloc] initWithStyle:UITableViewCellStyleSubtitle reuseIdentifier:CellIdentifier];
    }
	...
	[cell.reviewLabel setText: [NSString stringWithFormat:@"%lu", (unsigned long)[country.reviews count]]];
...
{	
	...
	{		
		...
		self.navigationItem.rightBarButtonItem = [[UIBarButtonItem alloc] initWithTitle:NSLocalizedString(@"Cancel", nil) style:UIBarButtonSystemItemSave target:self action:@selector(cancelDownload)];
