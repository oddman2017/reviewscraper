...
- (void)encodeWithCoder:(NSCoder *)coder
{
	...
	[coder encodeInt:(int)self.sortIndex forKey:@"sortindex"];
}
...
- (Country *)countryNamed:(NSString *)countryName
{
	...
	if(!country)
	{
		country = [[Country alloc] initWithName:countryName];
...
{	
	...
	{				
		...
		{
            @autoreleasepool {
			NSArray *reviewArray = [DownloadReviews downloadWithCountry:(int)[[CountryManager sharedManager] iTunesCodeForKey:[countryArray objectAtIndex:i]] countryName:[countryArray objectAtIndex:i] appCode:self.code pageNumber:currentPage];
